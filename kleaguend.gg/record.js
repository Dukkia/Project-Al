...
const createServer = (port, targetLang) => {
    ...
    app.get('/', async (req, res) => {
        try {
            ...
            const response = await axios.get('https://api.performfeeds.com/soccerdata/standings/1wajy57wfq6wo1qnta55rgx3an?_rt=b&_fmt=json&tmcl=8dz245skul7xcviumzumhlkwk');
...
// 영어 서버 실행
createServer(4472, 'en');

// 한국어 서버 실행
createServer(8272, 'ko');

// 일본어 서버 실행
createServer(8172, 'ja');